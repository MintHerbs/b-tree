...
export const MODULES = [
  ...
  { id: 'computer-vision',       label: 'Computer Vision',       Icon: Eye },
  {
    ...
    Icon: HardDrive,
    notes: [
      { filename: 'notes/process-threads', label: 'notes/process-threads.md' },
      { filename: 'labs/C Programming/introduction',                label: 'labs/introduction.md' },
      { filename: 'labs/C Programming/c-fundamentals',              label: 'labs/c-fundamentals.md' },
      { filename: 'labs/C Programming/the-quadratic-equation-question', label: 'labs/the-quadratic-equation-question.md' },
      { filename: 'labs/C Programming/system-calls-part-1',         label: 'labs/system-calls-part-1.md' },
      { filename: 'labs/C Programming/file-io-system-calls',        label: 'labs/file-io-system-calls.md' },
      { filename: 'labs/C Programming/pipes',                       label: 'labs/pipes.md' },
      { filename: 'labs/C Programming/process-creation-with-fork',  label: 'labs/process-creation-with-fork.md' },
      { filename: 'labs/C Programming/signals',                     label: 'labs/signals.md' },
      { filename: 'labs/C Programming/threads-and-mutex-locks',     label: 'labs/threads-and-mutex-locks.md' },
      { filename: 'labs/C Programming/directory-operations',        label: 'labs/directory-operations.md' },
    ],
  },
