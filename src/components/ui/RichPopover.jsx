...
import styles from './RichPopover.module.css'
    ...
    if (actionHref) {
      return (
        <a
          ...
          target="_blank"
        >
          <Play className={styles.actionIcon} /> {actionLabel}
        </a>
      )
    }

    return (
      <button className={styles.actionButton} onClick={onActionClick} type="button">
        <Play className={styles.actionIcon} /> {actionLabel}
      </button>
    )
  }
                  ...
                  <div className={styles.bottomRow}>
                    {meta ? (
                      <span className={styles.metaBadge}>
                        <Clock className={styles.metaIcon} /> {meta}
                      </span>
                    ) : (
                      <span />
                    )}
