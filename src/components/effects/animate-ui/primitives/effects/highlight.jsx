...
function Highlight({
  ...
  const propsBoundsOffset = boundsOffset;
  const boundsOffsetValue = propsBoundsOffset ?? DEFAULT_BOUNDS_OFFSET;
  const boundsOffsetTop = boundsOffsetValue.top ?? 0;
  const boundsOffsetLeft = boundsOffsetValue.left ?? 0;
  const boundsOffsetWidth = boundsOffsetValue.width ?? 0;
  const boundsOffsetHeight = boundsOffsetValue.height ?? 0;
