...
function FolderTrigger({ children, className, gitStatus, ...props }) {
  return (
...
function FileItem({ icon: Icon = FileIcon, className, children, gitStatus, ...props }) {
  return (
